...
```r
barplot(height = total_day$total_steps,names.arg=total_day$date,cex.names=0.68,las=3,col="gray")
abline(h=median(total_day$total_steps), lty=2,lwd=3, col="orange")
abline(h=mean(total_day$total_steps), lty=2,lwd=3, col="blue")
text(x = 0,y=median(total_day$total_steps),pos=3,labels = "median", col="orange")
...
hist(total_day_noNAs$total_steps,col="gray",breaks=20,main="Total steps per day",xlab="Steps per day")
abline(v=median(total_day$total_steps),lty=3, lwd=2, col="orange")
legend(legend="median","topright",lty=3,lwd=2,bty = "n")
```
